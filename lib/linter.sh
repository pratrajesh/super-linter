...
LANGUAGE_ARRAY=('ANSIBLE' 'ARM' 'BASH' 'BASH_EXEC'
  ...
  'PYTHON_MYPY' 'RAKU' 'RUBY' 'RUST_2015'
  'RUST_2018' 'RUST_2021' 'RUST_CLIPPY'
  'STATES'
  'TSX'
  'TYPESCRIPT_ES' "${TYPESCRIPT_STYLE_NAME}" 'XML' 'YAML')

## removed 'SHELL_SHFMT' 'SCALAFMT' 'GITLEAKS' 'GHERKIN' 'JSCPD' 'SQL' 'SQLFLUFF' 'TEKTON' 'SNAKEMAKE_LINT' 'SNAKEMAKE_SNAKEFMT' 'PYTHON_FLAKE8' 'PYTHON_ISORT'   from LANGUAGE_ARRAY
